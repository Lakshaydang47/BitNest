...
export const features = [
  ...
  },
  {
    ...
    icon: FileText,
    shortDescription: 'Complete Documentation of to understand how it bitnest can work in yourystem',
  ...
  },
  {
    ...
    title: 'Repo Search',
    icon: Search,
    shortDescription: 'Locate any file ypur account or public can be searched',
  ...
  {
    id: 'commits',
    title: 'Commit list and page',
    icon: MessageSquare,
    shortDescription: 'View all the commit list and page of your project.',
  ...
  {
    id: 'upcomming meeting feature',
    title: 'Upcoming meeting feature',
    icon: Mic,
